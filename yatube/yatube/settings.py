...
# SECRET_KEY = '4j)+8pr@3ys!$mq0d9)8tanx(+rkvap10jwcq4&$hzas4lvbqg'
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '4j)+8pr@3ys!$mq0d9)8tanx(+rkvap10jwcq4&$hzas4lvbqg')
...
# Путь к статическим данным вынесен в переменную:
